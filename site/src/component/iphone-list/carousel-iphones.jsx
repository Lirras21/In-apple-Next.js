...
function CarouselPhones() {
  ...
  return (
    <div className='flex justify-center mt-4'>
      <div className='flex justify-center items-center bg-white w-[75%] lg:w-[1108px] h-[470px]'>
        <div>
              ...
              >
                ...
                {isHovered &&
                  <div className='mt-6 flex h-[65px] text-white gap-[1px] opacity-0 group-hover:opacity-100  transition duration-1000'>
                    ...
                    <div className='flex text-sm text-center justify-center items-center w-1/3 bg-black hover:invert transition duration-500' onClick={() => setShowModal(!showModal)}>
